...
print(compress(chars1))  # Output: 6, and chars1 should be ["a","2","b","2","c","3"]
print(chars1[:6])

print(compress(chars2))  # Output: 1, and chars2 should be ["a"]
print(chars2[:1])

print(compress(chars3))  # Output: 4, and chars3 should be ["a","b","1","2"]
print(chars3[:4])
